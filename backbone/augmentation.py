...
class ImageAugmenter:
    ...
    def _geometry_augment(self, dropout_prob=0.15):
        # # rotation
        # rot_augs = [iaa.Fliplr(1), iaa.Flipud(1)]
        # for aug in rot_augs:
        ...
        #
        self._result_images.append(self._source_images.copy())
        self._result_labels.append(self._source_labels.copy())
        ...
        mask_modified_augs = [flip_lr, flip_ud, flip_lrud]  # flip_ud, flip_lrud
